...
myListOfHate4Kek=[
	...
	"kekosov",
	"\"Это вас просто вовремя не отчислили.\"",
	"Вам бы всё кеканьки да каканьки...",
	"Agent Smith is the hero mehmat deserves, but not the one it needs... anymore.",
	"Отстань, а.",
	"Ты можешь кекнуть, но знай -- я могу кикнуть.",
	"Чекни /weather.",
	"I am Error.",
	"XOB VLR COLJ QEB JXQOFU?",
	"BSBOVQEFKD FP CFKFQB. BSBK VLR.",
	"1FED41E48F8E78A46820074CE34E05D0F93D42D3",
	"CE2D15EBFBBEDE99BE34F805DBA03ED5B6EB7F7A",
	"Ну что кекаете? Что сразу кекаете-то? Сидят в своих интернетиках и кекают... К сессии-то готовы? Домашку на завтра сделали? Курсач начали техать?... Носки-то хоть постирали? Нет. Кекают тут. Что за народ...",
	"Не, двач уже не торт.",
	"Дахорош.",
...
wikiLangs=["en", "ru"]
myListOfURLs_Algebra={}
myListOfURLs_Calculus={}
myListOfURLs_FuncAn={}
